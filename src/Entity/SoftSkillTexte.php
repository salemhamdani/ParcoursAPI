 ...
 * SoftSkillTexte
 *
 * @ORM\Table(name="softskilltexte")
 * @ORM\Entity(repositoryClass="App\Repository\SoftSkillTexteRepository")
 * @ORM\HasLifecycleCallbacks()
 */
class SoftSkillTexte {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Cursus", inversedBy="softskilltextes",cascade={"persist"})
     */
    private $cursus;
