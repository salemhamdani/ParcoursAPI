 ...
 * TarifVenteIntraJour
 *
 * @ORM\Table(name="tarifVenteIntraJourClient")
 * @ORM\Entity(repositoryClass="App\Repository\TarifVenteIntraJourClientRepository")
 * @ORM\HasLifecycleCallbacks() 
 */
class TarifVenteIntraJourClient
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="TarifVenteThemeIntra", inversedBy="intrajourclients", cascade={"persist"})
    */
