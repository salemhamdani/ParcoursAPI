...
/**
 * TarifVenteIntraJourOf
 *
 * @ORM\Table(name="tarifVenteIntraJourOf")
 * @ORM\Entity(repositoryClass="App\Repository\TarifVenteIntraJourOfRepository")
 * @ORM\HasLifecycleCallbacks() 
 */
class TarifVenteIntraJourOf
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="TarifVenteThemeIntra", inversedBy="intrajourofs", cascade={"persist"})
    */
