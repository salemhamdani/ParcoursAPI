 ...
 * CursusMatiere
 *
 * @ORM\Table(name="cursusmatiere")
 * @ORM\Entity(repositoryClass="App\Repository\CursusMatiereRepository")
...
class CursusMatiere {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Cursus", inversedBy="matieres",cascade={"persist"})
     */
    private $cursus;
    ...
    */
     ...
     * Set matiere.
     *
     * @param \App\Entity\Masterlistelg|null $matiere
     *
     * @return CursusMatiere
     */
    public function setMatiere(\App\Entity\Masterlistelg $matiere = null)
    {
