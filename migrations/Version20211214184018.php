 ...
 */
final class Version20211214184018 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE type_formation_experience (experience_id INT NOT NULL, type_formation_id INT NOT NULL, INDEX IDX_BBD718F046E90E27 (experience_id), INDEX IDX_BBD718F0D543922B (type_formation_id), PRIMARY KEY(experience_id, type_formation_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
