 ...
 */
final class Version20211214155841 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entreprise_personal_informations (entreprise_id INT NOT NULL, personal_informations_id INT NOT NULL, INDEX IDX_69E523D1A4AEAFEA (entreprise_id), INDEX IDX_69E523D14D33B99D (personal_informations_id), PRIMARY KEY(entreprise_id, personal_informations_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE entretien_formateur_theme (entretien_formateur_id INT NOT NULL, theme_id INT NOT NULL, INDEX IDX_F502C8E61AF8CDF2 (entretien_formateur_id), INDEX IDX_F502C8E659027487 (theme_id), PRIMARY KEY(entretien_formateur_id, theme_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE tiers_stage (tiers_id INT NOT NULL, stage_id INT NOT NULL, INDEX IDX_D409F9C12298D193 (stage_id), INDEX IDX_D409F9C168B77723 (tiers_id), PRIMARY KEY(tiers_id, stage_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE type_public_experience (experience_id INT NOT NULL, type_public_id INT NOT NULL, INDEX IDX_233349F5172CA81 (type_public_id), INDEX IDX_233349F546E90E27 (experience_id), PRIMARY KEY(experience_id, type_public_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
